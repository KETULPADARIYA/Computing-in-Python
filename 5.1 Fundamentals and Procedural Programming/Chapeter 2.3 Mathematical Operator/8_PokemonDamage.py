...
Modifier=STAB*Type*Critical*Other*(Random in [0.85,1])   
Damage=((((2*Level+10)/250)*(Attack/Defense*Base)+2)*Modifier)
print("the total damage caused based on the STAB, Type, Critical, Other, Random,Level, Attack, Defense, and Base given above",Damage)
